using System.IO;
using System.Linq;
using Easy.Commerce.Services.Web.Api.Swagger.OperationFilters;
    ...
    public partial class Startup
    {
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                var xmlPath = Path.Combine(basePath, "Easy.Commerce.Services.Web.Api.xml");
        ...
        private void ConfigureSwagger(IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint("/api-docs/v1/apis.json", "Easy.Commerce APIs - v1");
        ...
        private Info GetSwaggerInfo()
        {
            return new Info
            {
                Title = "Easy.Commerce APIs - v1",
                Version = "v1",
                Description = "Our APIs are yours",
                TermsOfService = "Knock yourself out",
                Contact = new Contact
                {
                    Name = "Easy Commerce Team",
                    Email = "we.are.developer@easy.commerce.com.br",
                },
                License = new License
                {
                    Name = "Use under LICX",
